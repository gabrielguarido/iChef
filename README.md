...
Recipes Mobile App where you can post your own recipe and interact (like, dislike, comment) with other people's recipes.<br /><br />
...
* **MongoDB** - For constructing the database.
...
<br /><br />And if you still didn't get it, that's ok, you can take a look at the [detailed explanation here](https://www.geeksforgeeks.org/mern-stack/).
...
* **Future Release Note** :octocat: <br />
As a release of this project, there'll be a Docker :whale: implementation for facilitating the environment setup described above, so you won't have to worry about configuring database credentials or any other project's dependencies.
